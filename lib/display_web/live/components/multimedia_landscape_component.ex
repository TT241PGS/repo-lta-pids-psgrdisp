...
<<<<<<< HEAD
      <video :if={{@multimedia.type == "VIDEO"}} onloadstart="this.volume={{ @panel_audio_lvl }}" class="thick-borders media-item" autoplay loop>
=======
      <video :if={{@multimedia.type == "VIDEO"}} oncanplaythrough="this.volume={{ @panel_audio_lvl }}" class="thick-borders media-item" autoplay loop>
>>>>>>> develop
