defmodule PortraitThreePaneALayout do
  ...
  def render(assigns) do
    ~H"""
    <div style="flex-direction: column; display: flex" :if={{Utils.get_stop_predictions_realtime_set(@prop, @service_per_page) |> is_list and length(Utils.get_stop_predictions_realtime_set(@prop, @service_per_page)) > 0 }}>
