defmodule LandscapeTwoPaneBLayout do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <MultimediaTwoColumn multimedia={{@prop.multimedia}} image_sequence_url={{@prop.multimedia_image_sequence_current_url}} :if={{get_in(@prop.current_layout_panes, ["pane1", "type", "value"]) == "multimedia"}}/>
